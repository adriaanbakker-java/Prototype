...
public class VoorwaardenbeheerService {
    ...
    private void addBerichtgegeven(Bericht bericht, String pad) {
        Berichtgegeven berichtgegeven = new Berichtgegeven();
        berichtgegeven.setBericht(bericht);
        berichtgegeven.setPadnaargegeven(pad);
        berichtgegevenRepository.save(berichtgegeven);
    }

    private Bericht addBericht(String berichtnaam) {
        Bericht bericht = new Bericht();
        bericht.setBerichtnaam(berichtnaam);
        berichtenRepository.save(bericht);
        return bericht;
    }

    public void initDb() {
        Bericht bericht = addBericht("Bijstandsregelingen-v0500");

        //Bericht bericht = berichtenRepository.findBerichtByBerichtnaam("Bijstandsregelingen-v0500");
        addBerichtgegeven(bericht, "ClientSuwi/Uitkeringsverhouding/VrijstellingArbeidsplicht/CdVrijstellingArbeidsplichtBijst");
        addBerichtgegeven(bericht, "ClientSuwi/Uitkeringsverhouding/VrijstellingArbeidsplicht/CdRedenEVrijstArbeidsplichtBijst");
        addBerichtgegeven(bericht, "ClientSuwi/Uitkeringsverhouding/VrijstellingArbeidsplicht/DatBVrijstellingarbeidsplicht");

        bericht = addBericht("BRPDossierPersoonGSD-v0200");
        addBerichtgegeven(bericht, "ClientSuwi/Huwelijk/*");
        addBerichtgegeven(bericht, "ClientSuwi/Partner/*");

        bericht = addBericht("UWVDossierWerknemersverzekeringen-v0200");
        addBerichtgegeven(bericht, "ClientSuwi/Uitkeringsverhouding/DatBUitkeringsverhouding");
        addBerichtgegeven(bericht, "ClientSuwi/Uitkeringsverhouding/DatEUitkeringsverhouding");
        addBerichtgegeven(bericht, "ClientSuwi/Uitkeringsverhouding/SzWet/CdSzWet");
    }
}
